...
public class ModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CUSTOM_ITEMS = REGISTRY.register("custom_items",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.scp_genesis.custom_items")).icon(() -> new ItemStack(ModItems.KEYCARD_EC_LV5.get())).displayItems((parameters, tabData) -> {
