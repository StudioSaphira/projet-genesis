...
import net.scp_genesis.init.ScpGenesisModTabs;
import net.scp_genesis.init.ScpGenesisModItems;
...
@Mod("scp_genesis")
public class ScpGenesisMod {
	public static final Logger LOGGER = LogManager.getLogger(ScpGenesisMod.class);
	public static final String MODID = "scp_genesis";

	public ScpGenesisMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		ScpGenesisModBlocks.REGISTRY.register(modEventBus);
		ScpGenesisModItems.REGISTRY.register(modEventBus);
		ScpGenesisModTabs.REGISTRY.register(modEventBus);
