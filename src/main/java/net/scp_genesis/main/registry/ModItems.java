...
import net.scp_genesis.main.copycatblocks.item.CopycatRemoverItem;
import net.scp_genesis.main.copycatblocks.item.CopycatScraperItem;
import net.scp_genesis.main.copycatblocks.item.CopycatWrenchItem;
import net.scp_genesis.main.platform.PlatformRegistry;
import net.scp_genesis.main.platform.PlatformRegistryObject;
import net.scp_genesis.main.scps.item.cards.id.IDCardItem;
import net.scp_genesis.main.scps.item.cards.keycards.ExternalKeycardLv0Item;
import net.scp_genesis.main.scps.item.cards.keycards.O5KeycardItem;
import net.scp_genesis.main.scps.item.cards.keycards.admin.*;
import net.scp_genesis.main.scps.item.cards.keycards.ethics.*;
import net.scp_genesis.main.scps.item.cards.keycards.iia.*;
import net.scp_genesis.main.scps.item.cards.keycards.internal.*;
import net.scp_genesis.main.scps.item.cards.keycards.logistics.LogisticsKeycardLv0Item;
import net.scp_genesis.main.scps.item.cards.keycards.logistics.LogisticsKeycardLv1Item;
import net.scp_genesis.main.scps.item.cards.keycards.logistics.LogisticsKeycardLv2Item;
import net.scp_genesis.main.scps.item.cards.keycards.logistics.LogisticsKeycardLv3Item;
import net.scp_genesis.main.scps.item.cards.keycards.mjd.MJDKeycardLv1Item;
import net.scp_genesis.main.scps.item.cards.keycards.mjd.MJDKeycardLv2Item;
import net.scp_genesis.main.scps.item.cards.keycards.mjd.MJDKeycardLv3Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.*;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.alpha1.MTFAlpha1KeycardLv4Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.alpha1.MTFAlpha1KeycardLv5Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.alpha1.MTFAlpha1KeycardLv6Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.epsilon11.*;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.gamma8.MTFGamma8KeycardLv3Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.gamma8.MTFGamma8KeycardLv4Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.gamma8.MTFGamma8KeycardLv5Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.gamma8.MTFGamma8KeycardLv6Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.nu7.*;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.omega1.*;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.resh1.MTFResh1KeycardLv4Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.resh1.MTFResh1KeycardLv5Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.resh1.MTFResh1KeycardLv6Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.umbra6.MTFUmbra6KeycardLv1Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.umbra6.MTFUmbra6KeycardLv2Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.umbra6.MTFUmbra6KeycardLv3Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.zeta19.MTFZeta19KeycardLv2Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.zeta19.MTFZeta19KeycardLv3Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.zeta19.MTFZeta19KeycardLv4Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.zeta19.MTFZeta19KeycardLv5Item;
import net.scp_genesis.main.scps.item.cards.keycards.raisa.*;
...
import net.scp_genesis.main.scps.item.cards.keycards.mtf.antheia5.MTFAntheia5KeycardLv3Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.antheia5.MTFAntheia5KeycardLv4Item;
import net.scp_genesis.main.scps.item.cards.keycards.mtf.antheia5.MTFAntheia5KeycardLv5Item;
