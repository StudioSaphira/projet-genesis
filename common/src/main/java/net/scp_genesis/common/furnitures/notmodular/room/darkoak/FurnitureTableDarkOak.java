...
public class FurnitureTableDarkOak extends Block {
    ...
    public FurnitureTableDarkOak() {
        super(BlockBehaviour.Properties.ofFullCopy(Blocks.DARK_OAK_PLANKS).noOcclusion());
    }
