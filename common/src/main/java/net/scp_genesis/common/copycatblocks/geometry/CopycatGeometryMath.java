 ...
 */
public final class CopycatGeometryMath {

    private CopycatGeometryMath() {}

    public static @NotNull CopycatVertex lerp(
            @NotNull CopycatVertex a,
            @NotNull CopycatVertex b,
            float t
    ) {
     ...
     */
    public static @NotNull CopycatVector subtract(
            @NotNull CopycatVertex a,
            @NotNull CopycatVertex b
    ) {
        return new CopycatVector(
                b.x() - a.x(),
                b.y() - a.y(),
                b.z() - a.z()
        );
     ...
     */
    public static @NotNull CopycatVector add(
            @NotNull CopycatVector a,
            @NotNull CopycatVector b
    ) {
        return new CopycatVector(
                a.x() + b.x(),
                a.y() + b.y(),
     ...
     */
    public static @NotNull CopycatVertex offset(
            @NotNull CopycatVertex vertex,
            @NotNull CopycatVector offset
    ) {
        return new CopycatVertex(
                vertex.x() + offset.x(),
                vertex.y() + offset.y(),
     ...
     */
    public static @NotNull CopycatVertex rotateY(
            @NotNull CopycatVertex vertex,
            int rotations
    ) {
     ...
     */
    public static @NotNull CopycatVertex mirrorY(
            @NotNull CopycatVertex vertex
    ) {
        return new CopycatVertex(
                vertex.x(),
     ...
     */
    public static @NotNull CopycatVector cross(
            @NotNull CopycatVector a,
            @NotNull CopycatVector b
    ) {
        return new CopycatVector(
     ...
     * than three vertices
     */
    public static @NotNull CopycatVector normal(
     ...
     */
    public static @NotNull CopycatVector normalize(
            @NotNull CopycatVector vector
    ) {
        float length =
                length(vector);
